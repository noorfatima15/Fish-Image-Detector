              ...
              Center(
                child: Column(
                  children: [
                    ...
                    imageDataController.pickedImage != null
                        ? Container(
                            margin: const EdgeInsets.symmetric(vertical: 10),
                            height: 500,
                            width: 300,
                            child: Image.file(imageDataController.pickedImage))
                        : Container(),
                    imageDataController.pickedImageFile.value.isNotEmpty
                        // ? Text('${imageDataController.pickedImageFile.value[0]['label']} '.replaceAll(RegExp(r'[0-9]'), ''),
                        //     style: TextStyles.cyanTitle)
                        ? Text(
                            '${imageDataController.pickedImageFile.value} '.replaceAll(
                              RegExp(r'[0-9]'),
                              '',
                            ),
                            style: TextStyles.cyanTitle)
